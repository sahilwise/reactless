 ...
 <section className="sticky ">
       ...
       <div
          ...
          >
            ...
            >
              <span className="inline md:block">Open Source React &</span>
              <span
                className="relative mt-2 bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 to-teal-500 md:inline-block"
              > React <span className="bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-cyon-500 to-teal-500"> Native </span> Components</span>
            </h1>
          </div>
  ...
  <a
    ...
    >
    &nbsp;&nbsp;<Image width={20} height={20} src="/github.png" />&nbsp;&nbsp; Fork On Github
    </a>
    </Link>
  </span>
  </div>
  ...
  <div className="flex space-x-5 max-w-screen-xl px-4 py-8 mx-auto sm:px-6 lg:px-8">
    <h3 className="underline decoration-2 underline-offset-8">React js</h3>
    <h3>React Native</h3>
    <h4>Web View</h4>
  </div>
  {/* Components */}
